...
print("I think the result will be 3.")
let integerDivision = 10 / 3
print("The result is: \(integerDivision)")
...
print("The result if I use Double values: \(divisionResult)")
/*:
