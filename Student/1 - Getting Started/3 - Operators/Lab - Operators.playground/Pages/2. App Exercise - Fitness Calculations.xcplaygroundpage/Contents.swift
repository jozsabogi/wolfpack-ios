...
print("This differ from previous because division of Double variables will be Double too ")
...
print("The percent of the goal that has been achieved so far: \(percentOfGoal) %")
/*:
