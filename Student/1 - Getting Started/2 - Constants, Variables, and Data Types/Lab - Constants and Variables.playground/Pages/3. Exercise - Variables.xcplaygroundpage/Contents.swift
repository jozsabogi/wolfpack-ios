 ...
 */
var schooling = 3
print("I have completed \(schooling) year(s) of school")
...
schooling = 4
print("Now  have completed \(schooling) year(s) of school")
...
print("The code does compile, because var is mutable, so I can change the value later.")
