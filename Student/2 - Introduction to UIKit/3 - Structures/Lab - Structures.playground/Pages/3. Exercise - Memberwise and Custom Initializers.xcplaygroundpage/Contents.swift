...
print("Gps: \(somePlace.latitude), \(somePlace.longitude)")
...
var favoriteBook = Book(title: "Oh my book", author: "Shakespeare", pages: 200, price: 33.7)
print("Book info: \(favoriteBook.title), \(favoriteBook.author), \(favoriteBook.pages), \(favoriteBook.price)")
/*:
...
var height = Height(inches: 65)
print("\(height.heightInInches) inches = \(height.heightInCentimeters) cm")
...
print("\(myHeight.heightInCentimeters) cm = \(myHeight.heightInInches) inches")
