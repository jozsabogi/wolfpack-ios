...
progressUpdate(steps: 2, goal: 200)
progressUpdate(steps: 300, goal: 300)
...
func pacing(currentDistance: Double, totalDistance: Double, currentTime: Double, goalTime: Double) {
    let pace = currentTime * totalDistance / currentDistance
...
pacing(currentDistance: 10, totalDistance: 20, currentTime: 20, goalTime: 33)
/*:
