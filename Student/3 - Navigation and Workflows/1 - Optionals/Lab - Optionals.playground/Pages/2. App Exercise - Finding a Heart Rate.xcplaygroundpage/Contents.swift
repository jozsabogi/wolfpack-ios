...
heartRate = (oldHR1 + oldHR2 + oldHR3 + oldHR4) / 4
print(heartRate)
/*:
...
print(heartRate)
if heartRate != nil {
    let heartRateSum = heartRate! + oldHR1 + oldHR2 + oldHR3 + oldHR4
    let hrAverage = heartRateSum / 5
    print("hr + oldest: \(hrAverage)")
} else {
    let hrAverage = (oldHR1 + oldHR2 + oldHR3 + oldHR4) / 4
    print("oldest: \(hrAverage)")
}
